...
Set CMAKE_ENET= -DBUILD_ENET=FALSE
Set CMAKE_CLSOCKET= -DBUILD_CLSOCKET=FALSE
Set CMAKE_EXTRAS= -DBUILD_EXTRAS=FALSE
Set CMAKE_DYNAMIC_RUNTIME= -DUSE_MSVC_RUNTIME_LIBRARY_DLL=TRUE
cmake %CMAKE_GEN% %CMAKE_BULLET2_DEMO% %CMAKE_DYNAMIC_RUNTIME% %CMAKE_EXTRAS% %CMAKE_CLSOCKET% %CMAKE_ENET% %CMAKE_CPU_DEMO% %CMAKE_OPENGL3_DEMO% %CMAKE_USE_GLUT% %CMAKE_USE_GRAPHICAL_BENCHMARK% %CMAKE_CONFIGURATION_TYPE% ..
