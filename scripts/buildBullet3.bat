...
Set CMAKE_CLSOCKET= -DBUILD_CLSOCKER=FALSE
cmake %CMAKE_GEN% %CMAKE_BULLET2_DEMO% %CMAKE_CLSOCKET% %CMAKE_ENET% %CMAKE_CPU_DEMO% %CMAKE_OPENGL3_DEMO% %CMAKE_USE_GLUT% %CMAKE_USE_GRAPHICAL_BENCHMARK% %CMAKE_CONFIGURATION_TYPE% ..
